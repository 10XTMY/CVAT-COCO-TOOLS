...
tf.flags.DEFINE_integer('shard_num', 15, 'number of shards')
...
def _create_tf_record_from_coco_annotations(
  ...
  Args:
    ...
    include_masks: Whether to include instance segmentations masks
      (PNG encoded) in the result. default: False.
    num_shards: How many shards to split the data set across.
  """
    with tf.gfile.GFile(annotations_file, 'r') as fid:
        ...
        # limit the number of shards based on the number of images
        num_shards = min(num_shards, len(images))
...
def main(_):
    ...
    assert FLAGS.shard_num > 0, "Number of shards must be greater than 0."
